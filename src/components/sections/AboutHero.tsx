      ...
      <div className="py-16 md:pt-60 md:pb-20">
        ...
        <div className="flex flex-col max-w-3xl pt-16 lg:flex-row lg:items-baseline lg:justify-between lg:pt-32">
          ...
          <div className="max-w-md space-y-6 text-lg lg:text-2xl">
            <p>
              I am a successful SEO professional with a near-decade of experience
              working with tech companies, SMBs, and large enterprises in the
              finance, real estate, chemical additives, oil and gas, and
              water/wastewater industries. For years, I have been executing and
              optimizing organic digital campaigns, generating inbound leads and
              increasing web traffic for my clients.
            </p>
            <p>
              I work at the convergence of digital strategy, design, and development,
              providing effective, engaging, and elegant web experiences. Every new
              project is an opportunity to help my clients challenge the status quo
              with bespoke solutions rooted in creativity and insight.
            </p>
          </div>
        </div>
      </div>
