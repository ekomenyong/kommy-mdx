...
<KommyImage
  ...
  width={1200}
  height={675}
  caption="The modern WordPress tools and plugins I was using in 2018."
  priority
/>
...
<KommyImage
  ...
  height={675}
  priority
  caption="A screenshot of Sanity Studio"
/>

### Exploring Sanity.io

The next time I rebuilt my personal site using the Jamstack, I chose [Sanity](https://www.sanity.io/) as my CMS of choice. The reasons I chose Sanity include:
...
Though my personal website is currently [built using markdown via MDX](/posts/rebuilding-blog-nextjs-mdx-tailwindcss), I do plan to revisit Sanity as my CMS of choice for more complex projects.
